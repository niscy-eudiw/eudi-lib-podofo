...
int main()
{
    try {
        ...
        string conformanceLevel = "ADES_B_LT";  // OR ADES_B_B
        ...
        validationData.certificatesBase64 = { my_end, my_chain1, my_tsr };  // Order: signer -> intermediate -> root -> tsr
		validationData.crlsBase64 = { crl_info_my_end, crl_info_my_chain1 };

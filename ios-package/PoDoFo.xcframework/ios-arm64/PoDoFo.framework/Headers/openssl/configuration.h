/*
 * WARNING: do not edit!
 * Generated by configdata.pm from build/ios/openssl/build/openssl-3.2.1/Configurations/common0.tmpl, build/ios/openssl/build/openssl-3.2.1/Configurations/unix-Makefile.tmpl
 * via Makefile.in
 *
